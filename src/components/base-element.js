...
export class BaseElement extends HTMLElement {
	...
	async initWjElement (force = false) {
		...
		//sheet.replaceSync(".button-native {background-color: red;}");
		console.log("base_element","wj-button-solid:"+this.constructor.cssStyleSheet);
		this.context.adoptedStyleSheets = [sheet];
        console.log("base_element","wj-button-solid:"+JSON.stringify(sheet));
		console.log("base_element","wj-button-solid:"+JSON.stringify(this.context.adoptedStyleSheets));
...
let __esModule = 'true';
export {__esModule, WjPermissionsApi, WjElementUtils, event};
customElements.get("base-element") || customElements.define("base-element", BaseElement);